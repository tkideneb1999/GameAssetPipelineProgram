...
class Ui_pipeline_step(object):
    def setupUi(self, pipeline_step):
        ...
        pipeline_step.setMinimumSize(QtCore.QSize(400, 110))
        ...
        self.add_input_button.setMinimumSize(QtCore.QSize(100, 0))
        ...
        self.add_output_button.setMinimumSize(QtCore.QSize(100, 0))
