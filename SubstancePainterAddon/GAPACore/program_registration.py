...
class ProgramRegistration:
    ...
    def add_program(self, name, path, addon_enabled=False):
    ...
    def get_program_path(self, name) -> Path:
        # name: str
        return self.registered_programs[name]["path"]

    def get_program_addon_path(self, name) -> Path:
        # name: str
        return self.registered_programs[name]["addonPath"]

    def get_program_addon_enabled(self, name) -> bool:
        # name: str
    ...
    def enable_addon(self, name, addon_path) -> None:
