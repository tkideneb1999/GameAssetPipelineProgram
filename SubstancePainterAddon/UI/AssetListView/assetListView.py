...
from . import assetList_GUI as alG
from .. import warningPopUp as wPU
...
class AssetListView(qtw.QWidget):
    ...
    def __init__(self, parent=None, mode=0):
        ...
        self.ui = alG.Ui_asset_list_widget()
...
#
    ...
    def remove_asset(self, lvl_name, asset_name):
        warning_dialog = wPU.WarningPopUp("This will remove the asset from the project!"
    ...
    def remove_level(self, lvl_name):
        warning_dialog = wPU.WarningPopUp("This will remove the level and the assets contained in it from the project!"
                                      "\nThe data will be marked deprecated and can still be accessed by navigating the folder structure.")
        if warning_dialog.exec_() == 1:
...
class TreeAsset(qtw.QTreeWidgetItem):
    def __init__(self, name: str, level: qtw.QTreeWidgetItem, tags: list):
